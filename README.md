...
## About this Project
This is a Multipurpose chatbot made using Python3, who can chat with you and help in performing daily tasks. It uses NLP and Deep-Learning to analyse the user's message and classify it into the a broader category and then reply with a suitable message or information. It is hosted using flask and is available on heroku at the link specified above. 
